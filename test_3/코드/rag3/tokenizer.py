"""한국어 토크나이저. chromadb 등 무거운 의존성이 없어 check에서도 import 가능.

기본은 kiwipiepy 형태소 분석기. 미설치 시 경고 후 char_bigram으로 자동 폴백한다.
"""
...
def tokenize_ko(text: str, tokenizer: str = "kiwi") -> list[str]:
    if tokenizer == "kiwi":
